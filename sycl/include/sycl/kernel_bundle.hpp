...
public:
  ...
  /////////////////////////
  template <bundle_state _State = State>
  std::enable_if_t<_State == State && _State != bundle_state::ext_oneapi_source,
                   std::vector<char>>
  ext_oneapi_get_content();
  ...
  std::enable_if_t<_State == State && _State != bundle_state::ext_oneapi_source,
                   sycl::span<char>>
  ext_oneapi_get_content_sycl_view();

#if __cpp_lib_span
  template <bundle_state _State = State>
  std::enable_if_t<_State == State && _State != bundle_state::ext_oneapi_source,
                   std::span<char>>
  ext_oneapi_get_content_view();
#endif
...
compile(kernel_bundle<bundle_state::ext_oneapi_source> &SourceKB,
  ...
  return detail::compile_from_source(SourceKB, Devices, CompileOptionsVec, LogPtr,
                                     RegisteredKernelNamesVec);
}
