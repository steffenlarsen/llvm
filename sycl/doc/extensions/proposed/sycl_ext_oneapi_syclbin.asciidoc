...
The link:../../design/SYCLBINDesign.asciidoc[SYCLBINDesign] design document
details the implementation of this extension in DPC++, including the format
used for SYCLBIN files.
