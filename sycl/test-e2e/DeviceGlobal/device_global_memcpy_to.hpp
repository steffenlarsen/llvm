...
int test() {
  ...
  Q.memcpy(DeviceGlobalVar1, RefArr);
  Q.memcpy(DeviceGlobalVar2, RefArr, 2 * sizeof(int));
  Q.memcpy(DeviceGlobalVar2, RefArr + 3, sizeof(int), 3 * sizeof(int));
  Q.memcpy(DeviceGlobalVar3, &RefStruct);
  Q.wait_and_throw();
