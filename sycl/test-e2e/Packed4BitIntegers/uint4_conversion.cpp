...
// Test for conversion to and from packed 4-bit unsigned integer types.
...
static constexpr int8_t Vals[NumVals] = {0, 1, 2,  3,  4,  5,  6,  7,
...
int main() {
  ...
  Failed += test<oneapiexp::uint4_packed<NumVals, uint8_t>, sycl::half>(Q);
  Failed +=
      test<oneapiexp::uint4_packed<NumVals, uint8_t>, oneapi::bfloat16>(Q);
  Failed += test<oneapiexp::uint4_packed<NumVals, uint8_t>, int8_t>(Q);
  Failed += test<oneapiexp::uint4_packed<NumVals, uint8_t>, uint8_t>(Q);
  Failed += test<oneapiexp::uint4_packed<NumVals, uint32_t>, sycl::half>(Q);
  Failed +=
      test<oneapiexp::uint4_packed<NumVals, uint32_t>, oneapi::bfloat16>(Q);
  Failed += test<oneapiexp::uint4_packed<NumVals, uint32_t>, int8_t>(Q);
  Failed += test<oneapiexp::uint4_packed<NumVals, uint32_t>, uint8_t>(Q);
